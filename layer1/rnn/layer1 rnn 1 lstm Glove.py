...
EMBEDDING_FILE = 'F:/DS-main/BigFiles/glove.42B.300d/glove.42B.300d.txt'
...
with codecs.open(TEST_DATA_FILE, encoding='utf-8') as f:
    ...
    for values in reader:
        ...
        if (len(test_texts_1)%100000 == 0 ):
            print ('proc test',len(test_texts_1))
...
model_checkpoint = ModelCheckpoint(bst_model_path, save_best_only=True, save_weights_only=True, verbose=2)
...
submission.to_csv('glove'+STAMP+'.csv', index=False)
...
submission.to_csv('glove'+STAMP+'Train.csv', index=False)
