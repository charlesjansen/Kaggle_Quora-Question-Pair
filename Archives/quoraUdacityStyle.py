...
STAMP = 'Ud-lstm_%d_%d_%.2f_%.2f'%(num_lstm, num_dense, rate_drop_lstm, \
        rate_drop_dense)
...
with codecs.open(TRAIN_DATA_FILE, encoding='utf-8') as f:
    ...
    for values in reader:
        texts_1.append(text_to_wordlist(values[3], remove_stopwords=False, stem_words=True))
        texts_2.append(text_to_wordlist(values[4], remove_stopwords=False, stem_words=True))
...
with codecs.open(TEST_DATA_FILE, encoding='utf-8') as f:
    ...
    header = next(reader)
    for values in reader:
        test_texts_1.append(text_to_wordlist(values[1], remove_stopwords=False, stem_words=True))
        test_texts_2.append(text_to_wordlist(values[2], remove_stopwords=False, stem_words=True))
