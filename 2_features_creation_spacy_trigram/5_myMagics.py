...
TRAIN_DATA_FILE = drive + ':/DS-main/Kaggle-main/Quora Question Pairs - inputs/data/train_spacy_cleaned.csv'
TEST_DATA_FILE  = drive + ':/DS-main/Kaggle-main/Quora Question Pairs - inputs/data/test_spacy_cleaned.csv'

print("loading train")
train_orig =  pd.read_csv(TRAIN_DATA_FILE, header=0).fillna("-empty-").astype(str)
print("loading test")
test_orig =  pd.read_csv(TEST_DATA_FILE, header=0).fillna("-empty-").astype(str)
print("data loaded")
...
#saving
train_orig.to_csv(drive + ':/DS-main/Kaggle-main/Quora Question Pairs - inputs/data/train_myMagic3_spacy_cleaned.csv') 
test_orig.to_csv(drive + ':/DS-main/Kaggle-main/Quora Question Pairs - inputs/data/test_myMagic3_spacy_cleaned.csv')
