...
data = pd.read_csv('F:/DS-main/Kaggle-main/Quora Question Pairs - inputs/data/train.csv')
...
embeddings_index = {}
f = open('F:/DS-main/BigFiles/glove.42B.300d/glove.42B.300d.txt', encoding="utf8")
for line in tqdm(f):
    values = line.split()
    word = values[0]
