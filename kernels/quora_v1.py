...
STAMP = '20170501-2040lstm_%d_%d_%.2f_%.2f'%(num_lstm, num_dense, rate_drop_lstm, \
        rate_drop_dense)
...
merged = Dense(num_dense, activation=act, kernel_initializer = 'truncated_normal')(merged)
merged = Dropout(rate_drop_dense)(merged)
merged = Dense(num_dense, activation=act, kernel_initializer = 'truncated_normal')(merged)
merged = Dropout(rate_drop_dense)(merged)
merged = Dense(num_dense, activation=act, kernel_initializer = 'truncated_normal')(merged)
...
hist = model.fit([data_1_train, data_2_train], labels_train, \
        ...
        epochs=60, batch_size=512, shuffle=True, \
